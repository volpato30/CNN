...
Conv2DLayer = lasagne.layers.Conv2DDNNLayer
...
def inception_module(l_in, num_1x1, reduce_3x3, num_3x3, reduce_5x5, num_5x5, gain=1.0, bias=0.1):
    ...
    if num_3x3 > 0:
        if reduce_3x3 > 0:
            ...
            l_reduce_3x3 = l_in
        l_3x3 = Conv2DLayer(l_reduce_3x3, num_filters=num_3x3, filter_size=(3, 3), border_mode="same", W=lasagne.init.Orthogonal(gain), b=lasagne.init.Constant(bias))
    ...
    if num_5x5 > 0:
        if reduce_5x5 > 0:
            ...
            l_reduce_5x5 = l_in
        l_5x5 = Conv2DLayer(l_reduce_5x5, num_filters=num_5x5, filter_size=(5, 5), border_mode="same", W=lasagne.init.Orthogonal(gain), b=lasagne.init.Constant(bias))
