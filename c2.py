...
def evaluate_lenet5(learning_rate=0.12, n_epochs=200,
    ...
    # 4D output tensor is thus of shape (batch_size, nkerns[1], 30, 30)
            ...
            if (iter + 1) % validation_frequency == 0:
                ...
                if this_validation_loss < best_validation_loss:
                    ...
                    with open('c2.pkl', 'wb') as f:
                        pickle.dump([layer0,layer1,layer1b,layer2,layer3], f)
...
if __name__ == '__main__':
    evaluate_lenet5(nkerns=[20, 30,50],n_epochs=100)
